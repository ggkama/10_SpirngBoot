...
public class CommentController {
	...
	@GetMapping
	public ResponseEntity<List<CommentDTO>> selectCommentList(@RequestBody Map<String, String> request){
		return ResponseEntity.ok(commentService.selectCommentList(Long.parseLong(request.get("boardNo"))));
	}
